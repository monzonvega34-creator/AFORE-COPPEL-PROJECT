...
df_ultimo = df_ultimo[df_ultimo["afore"] != "pensiones bienestar"]  # ← agrega esta línea

df_ultimo["monto_ahorro_voluntario_y_solidario"] *= 1000
df_ultimo["monto_recursos_administrados_afores"] *= 1000
...
fig11.update_layout(
    ...
    funnelmode="stack",
    height=750,
    margin=dict(l=200, r=80, t=100, b=40),  # aumenta l para que las etiquetas no se corten
    plot_bgcolor="white",
    paper_bgcolor="white",
    font=dict(family="Arial"),
    yaxis=dict(
        tickfont=dict(size=30, family="Arial Bold", color="#333333")  # <-- ajusta size a tu gusto
    )
)
# ── Boxplot + Jitter ───────────────────────────────────────────
df_anual = df2.copy()
...
graficas_2 = [
    ...
    ("Promedio de Incremento Mensual por Mes", fig14),  # ← nueva
]
